...
{
#define _runningType 0
#define _chunkingType 1
#define _minChunkSize 4096
#define _averageChunkSize 8192
#define _maxChunkSize 16384
#define _slidingWinSize 256
#define _ReadSize 128
#define _segmentSize 0
